...
type BaseConfig struct {
	TomlDatabaseReconnectionTimeout string `toml:"db_reconnect_timeout_sec"`
	...
	DatabaseReconnectionTimeout time.Duration `internal:"db_reconnect_timeout_sec"`
...
func (bc *BaseConfig) AddMissingFromDefaults() error {
	defaults := &BaseConfig{
		...
		DatabaseReconnectionTimeout: time.Second * 3,
